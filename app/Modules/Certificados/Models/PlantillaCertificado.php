...
class PlantillaCertificado extends Model
{
    ...
    {
        $institucion = 'Instituto Americano Libertad';
        $pieNota = 'Verifique la autenticidad de este documento en la sección "Verificar certificado" del portal Americano Libertad.';
        $colorAcento = '#137A6C';
        // Las constancias con membrete institucional (ver resources/views/pdf/certificado.blade.php)
        // usan el azul del escudo de Americano Libertad en vez del verde genérico.
