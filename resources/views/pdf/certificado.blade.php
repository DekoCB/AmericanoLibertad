...
<body>
    <table class="encabezado">
        <tr>
            <td class="logo-celda"><img src="{{ public_path('images/Logo.png') }}" alt="Instituto Americano Libertad"></td>
            <td>
                @if ($plantilla->institucion)
                    <p class="institucion">{{ $plantilla->institucion }}</p>
                @endif
                <p class="colegio-nombre">INSTITUTO<span>AMERICANO LIBERTAD</span></p>
                <p class="colegio-subtitulo">Instituto Superior Tecnológico Privado</p>
            </td>
        </tr>
    </table>
    <hr class="regla">
    ...
    <div class="firma">
        ...
        <p>DIRECTOR</p>
        <p>INSTITUTO AMERICANO LIBERTAD</p>
    </div>
