...
>
    <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <a href="#inicio" class="flex items-center gap-3">
            ...
            <span class="leading-tight">
                ...
                <span class="block text-[11px] font-medium text-gray-400">Educación técnica superior</span>
            </span>
        </a>
        ...
        <div class="hidden items-center gap-4 lg:flex">
            <a href="{{ route('login') }}" wire:navigate class="text-sm font-medium text-gray-400 transition hover:text-white">Ingresar al sistema</a>
            <x-landing.cta-button :href="route('admision.create')" navigate variant="primary">Solicita tu admisión</x-landing.cta-button>
        </div>
    ...
    >
        <nav class="flex flex-col gap-1">
            ...
            @endforeach
            <a href="{{ route('login') }}" wire:navigate class="rounded-lg px-3 py-2.5 text-sm font-medium text-gray-400 transition hover:bg-white/5 hover:text-white">Ingresar al sistema</a>
        </nav>
        <x-landing.cta-button :href="route('admision.create')" navigate variant="primary" class="mt-3 w-full">Solicita tu admisión</x-landing.cta-button>
    </div>
</header>
