...
{{--
    ...
    azul en el pecho que lo liga a la paleta del Design System en vez de
...
>
    ...
    <g transform="translate(148 16) rotate(18)">
        <rect x="0" y="0" width="30" height="30" rx="7" fill="#2563EB" />
    ...
    <!-- Mochila -->
    <rect x="40" y="96" width="26" height="56" rx="10" fill="#2563EB" />
    ...
    <rect x="146" y="46" width="14" height="10" rx="3" fill="#2563EB" />
    ...
    <path d="M100 148.5 L102.3 152.8 L107 153.4 L103.5 156.5 L104.5 161 L100 158.6 L95.5 161 L96.5 156.5 L93 153.4 L97.7 152.8 Z" fill="#93C5FD" />
