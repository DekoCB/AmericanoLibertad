    ...
    return (
        <Base {...props}>
            <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M20.25 14.15v4.25c0 1.094-.787 2.036-1.872 2.18-2.087.277-4.216.42-6.378.42s-4.291-.143-6.378-.42c-1.085-.144-1.872-1.086-1.872-2.18v-4.25m16.5 0a2.18 2.18 0 0 0 .75-1.653v-2.4c0-.905-.474-1.744-1.267-2.176-1.86-1.014-4.032-1.59-6.335-1.59a12.72 12.72 0 0 0-6.335 1.59c-.793.432-1.267 1.271-1.267 2.176v2.4c0 .626.283 1.213.75 1.653m16.5 0a12.622 12.622 0 0 1-16.5 0m0 0-.256-.256a2.25 2.25 0 0 1-.659-1.591V9.75a2.25 2.25 0 0 1 2.25-2.25h13.5a2.25 2.25 0 0 1 2.25 2.25v2.553a2.25 2.25 0 0 1-.659 1.591l-.256.256M9 12h6"
            />
        </Base>
    );
}
    ...
    return (
        <Base {...props}>
            <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M2.25 18.75a60.07 60.07 0 0 1 15.797 2.101c.727.198 1.453-.342 1.453-1.096V18.75M3.75 4.5v.75A.75.75 0 0 1 3 6h-.75m0 0v-.375c0-.621.504-1.125 1.125-1.125H20.25M20.25 4.5v.75c0 .414.336.75.75.75h.75m-1.5-1.5h.375c.621 0 1.125.504 1.125 1.125v9.75c0 .621-.504 1.125-1.125 1.125h-.375m1.5-1.5H21a.75.75 0 0 0-.75.75v.75m0 0H3.75m0 0h-.375a1.125 1.125 0 0 1-1.125-1.125V15m1.5 1.5v-.75A.75.75 0 0 0 3 15h-.75M15 10.5a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm3 0h.008v.008H18V10.5Zm-12 0h.008v.008H6V10.5Z"
            />
        </Base>
    );
}
    ...
    return (
        <Base {...props}>
            <path
                strokeLinecap="round"
                strokeLinejoin="round"
                d="M3.75 13.5 13.5 2.25 12 10.5h8.25L10.5 21.75 12 13.5H3.75Z"
            />
        </Base>
    );
}
