...
const particles: {
    ...
    { top: '8%', left: '6%', size: 6, duration: 11, delay: 0, dx: 26, color: 'bg-white' },
    { top: '18%', left: '34%', size: 5, duration: 13, delay: 2, dx: -20, color: 'bg-blue-200' },
    { top: '30%', left: '18%', size: 8, duration: 9, delay: 1, dx: 16, color: 'bg-white' },
    { top: '46%', left: '9%', size: 5, duration: 12, delay: 3, dx: -22, color: 'bg-blue-200' },
    { top: '60%', left: '28%', size: 6, duration: 10, delay: 0.5, dx: 18, color: 'bg-white' },
    { top: '72%', left: '15%', size: 5, duration: 14, delay: 4, dx: -16, color: 'bg-blue-200' },
    { top: '15%', left: '55%', size: 5, duration: 11, delay: 1.5, dx: 22, color: 'bg-white' },
    { top: '38%', left: '48%', size: 7, duration: 10, delay: 3.5, dx: -18, color: 'bg-blue-200' },
    { top: '55%', left: '60%', size: 5, duration: 13, delay: 2.5, dx: 16, color: 'bg-white' },
    { top: '10%', left: '80%', size: 6, duration: 9, delay: 1, dx: -26, color: 'bg-blue-200' },
    { top: '25%', left: '90%', size: 5, duration: 12, delay: 4.5, dx: 14, color: 'bg-white' },
    { top: '42%', left: '72%', size: 8, duration: 11, delay: 0, dx: -16, color: 'bg-blue-200' },
    { top: '65%', left: '85%', size: 5, duration: 13, delay: 2, dx: 20, color: 'bg-white' },
    { top: '80%', left: '65%', size: 6, duration: 9.5, delay: 3, dx: -24, color: 'bg-blue-200' },
    { top: '88%', left: '40%', size: 5, duration: 12, delay: 5, dx: 18, color: 'bg-white' },
    { top: '5%', left: '48%', size: 5, duration: 10.5, delay: 1.5, dx: -14, color: 'bg-blue-200' },
    { top: '92%', left: '20%', size: 6, duration: 10, delay: 0.5, dx: 16, color: 'bg-white' },
    { top: '35%', left: '5%', size: 5, duration: 13.5, delay: 4, dx: 24, color: 'bg-blue-200' },
];
