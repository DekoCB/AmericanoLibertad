                                        ...
                                        <tr key={student.student_id}>
                                            ...
                                            <td className="px-2 py-2">
                                                <input
                                                    ...
                                                    step="0.01"
                                                    className="block w-24 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300"
                                                    value={
                                                        data.grades[index]
                                                            ?.score ?? ''
                                                    }
